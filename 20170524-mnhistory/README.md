# Star Tribune - Historical Minnesota Census Maps
...
1. Get code and enter project: `git clone https://github.com/striblab/20170524-mnhistory.git && cd 20170524-mnhistory.git`
...
2. Copy files (update path as needed): `mkdir -p ../20170524-mnhistory/ && rsync -rav ./ ../20170524-mnhistory/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
