# Star Tribune Data Drop - Census surnames
...
1. Get code and enter project: `git clone https://github.com/striblab/20161215-census_names.git && cd 20161215-census_names.git`
...
2. Copy files (update path as needed): `mkdir -p ../20161215-census_names/ && rsync -rav ./ ../20161215-census_names/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
