# Star Tribune - Minneapolis' digital divide
...
1. Get code and enter project: `git clone https://github.com/striblab/20160304-digital_divide.git && cd 20160304-digital_divide.git`
...
2. Copy files (update path as needed): `mkdir -p ../20160304-digital_divide/ && rsync -rav ./ ../20160304-digital_divide/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
