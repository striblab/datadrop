...
1. Get code and enter project: `git clone https://github.com/striblab/20170518-babynames.git && cd 20170518-babynames.git`
...
2. Copy files (update path as needed): `mkdir -p ../20170518-babynames/ && rsync -rav ./ ../20170518-babynames/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
