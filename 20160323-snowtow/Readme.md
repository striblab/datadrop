...
1. Get code and enter project: `git clone https://github.com/striblab/20160323-snowtow.git && cd 20160323-snowtow.git`
...
2. Copy files (update path as needed): `mkdir -p ../20160323-snowtow/ && rsync -rav ./ ../20160323-snowtow/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
