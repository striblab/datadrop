# Star Tribune Data Drop - Schools Beating the Odds
...
1. Get code and enter project: `git clone https://github.com/striblab/20171110-beating_the_odds.git && cd 20171110-beating_the_odds.git`
...
2. Copy files (update path as needed): `mkdir -p ../20171110-beating_the_odds/ && rsync -rav ./ ../20171110-beating_the_odds/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
