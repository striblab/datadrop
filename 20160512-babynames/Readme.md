...
1. Get code and enter project: `git clone https://github.com/striblab/20160512-babynames.git && cd 20160512-babynames.git`
...
2. Copy files (update path as needed): `mkdir -p ../20160512-babynames/ && rsync -rav ./ ../20160512-babynames/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
