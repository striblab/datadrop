# Star Tribune - Internet Usage in Minnesota
...
Data source: [U.S. Census Bureau, American Community Survey 2016, Computer and Internet Use in the United States](https://www.census.gov/topics/population/computer-internet.html)
...
1. Get code and enter project: `git clone https://github.com/striblab/20170830-internet_usage.git && cd 20170830-internet_usage.git`
...
2. Copy files (update path as needed): `mkdir -p ../20170830-internet_usage/ && rsync -rav ./ ../20170830-internet_usage/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
