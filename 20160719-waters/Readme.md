...
1. Get code and enter project: `git clone https://github.com/striblab/20160719-waters.git && cd 20160719-waters.git`
...
2. Copy files (update path as needed): `mkdir -p ../20160719-waters/ && rsync -rav ./ ../20160719-waters/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
