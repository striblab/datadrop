...
function chartTrend() {
    ...
    var chart = c3.generate({
        ...
        color: {
            pattern: ["#f7f7f7", "#d9d9d9", "#bdbdbd", "#969696", "#737373", "#525252", "#252525", "#A52129", "#00BB00"]
        },
        axis: {
            y: {
                max: 0.10,
...
function chartDeaths() {
    ...
    var chartDeaths = c3.generate({
        ...
        color: {
            pattern: ["#f7f7f7", "#d9d9d9", "#bdbdbd", "#969696", "#737373", "#525252", "#252525", "#A52129"]
        },
        axis: {
            y: {
                max: 0.20,
