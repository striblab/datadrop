# Star Tribune Data Drop - The urban bias of Pokemon GO
...
1. Get code and enter project: `git clone https://github.com/striblab/20160803_pokemongo.git && cd 20160803_pokemongo.git`
...
2. Copy files (update path as needed): `mkdir -p ../20160803_pokemongo/ && rsync -rav ./ ../20160803_pokemongo/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
