...
1. Get code and enter project: `git clone https://github.com/striblab/20170301-charter_enrollment.git && cd 20170301-charter_enrollment.git`
...
2. Copy files (update path as needed): `mkdir -p ../20170301-charter_enrollment/ && rsync -rav ./ ../20170301-charter_enrollment/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
