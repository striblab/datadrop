# Star Tribune - National park attendence
...
1. Get code and enter project: `git clone https://github.com/striblab/20160609-parks.git && cd 20160609-parks.git`
...
2. Copy files (update path as needed): `mkdir -p ../20160609-parks/ && rsync -rav ./ ../20160609-parks/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
