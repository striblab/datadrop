# Star Tribune Data Drop - Minnesota jobs that are expected to grow
...
1. Get code and enter project: `git clone https://github.com/striblab/20160531-jobs.git && cd 20160531-jobs.git`
...
2. Copy files (update path as needed): `mkdir -p ../20160531-jobs/ && rsync -rav ./ ../20160531-jobs/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
