...
```html
<div data-pym-src="http://static.startribune.com/projects/police-force">Loading...</div>
...
```js
{
  "publish": {
    "default": {
      ...
      "path": "news/projects-staging/all/police-force/",
      "url": "http://static.startribune.com/news/projects-staging/all/police-force/"
    },
    "production": {
      "bucket": "static.startribune.com",
      "path": "news/projects/all/police-force/",
      "url": "http://static.startribune.com/news/projects/all/police-force/"
    }
  }
}
```
