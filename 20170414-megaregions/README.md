# Star Tribune - Welcome to Laurentide - the Twin Cities as a megaregion
...
1. Get code and enter project: `git clone https://github.com/striblab/20170414-megaregions.git && cd 20170414-megaregions.git`
...
2. Copy files (update path as needed): `mkdir -p ../20170414-megaregions/ && rsync -rav ./ ../20170414-megaregions/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
