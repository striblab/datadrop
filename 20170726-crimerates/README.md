# Star Tribune - Minneapolis police shootings versus crime rates
...
1. Get code and enter project: `git clone https://github.com/striblab/20170722-crimerates.git && cd 20170722-crimerates.git`
...
2. Copy files (update path as needed): `mkdir -p ../20170722-crimerates/ && rsync -rav ./ ../20170722-crimerates/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
