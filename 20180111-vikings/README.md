...
```html
<div data-pym-src="http://static.startribune.com/projects/20180120-vikings">Loading...</div>
...
```js
{
  "publish": {
    "default": {
      ...
      "path": "news/projects-staging/all/20180120-vikings/",
      "url": "http://static.startribune.com/news/projects-staging/all/20180120-vikings/"
    },
    "production": {
      "bucket": "static.startribune.com",
      "path": "news/projects/all/20180120-vikings/",
      "url": "http://static.startribune.com/news/projects/all/20180120-vikings/"
    }
  }
}
```
