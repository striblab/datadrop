# Star Tribune - Suicide in Minnesota
...
1. Convert to CSV: `in2csv --sheet="Data" builds/development/data/maindata.xlsx | tail -n +4 > builds/development/data/maindata.csv`
