# Star Tribune - Hospital Score Card
...
1. Get code and enter project: `git clone https://github.com/striblab/20160616-hospitalscorecard.git && cd 20160616-hospitalscorecard.git`
...
2. Copy files (update path as needed): `mkdir -p ../20160616-hospitalscorecard/ && rsync -rav ./ ../20160616-hospitalscorecard/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
