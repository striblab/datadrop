# Star Tribune - Minnesota tops turkey production nationwide
...
1. Get code and enter project: `git clone https://github.com/striblab/20161121-turkeys.git && cd 20161121-turkeys.git`
...
2. Copy files (update path as needed): `mkdir -p ../20161121-turkeys/ && rsync -rav ./ ../20161121-turkeys/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
