# Star Tribune - Minneapolis Capital School Expenditures

A look at major infrastructural spending on Minneapolis schools. Created by [Frey Hargarten](https://github.com/jeffhargarten).
...
1. Get code and enter project: `git clone https://github.com/striblab/20170628-mntaxes.git && cd 20170628-mntaxes.git`
...
2. Copy files (update path as needed): `mkdir -p ../20170712-schools/ && rsync -rav ./ ../20170712-schools/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
