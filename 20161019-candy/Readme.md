# Star Tribune - Twin Cities Halloween Candy Index
...
1. Get code and enter project: `git clone https://github.com/striblab/20161019-candy.git && cd 20161019-candy.git`
...
2. Copy files (update path as needed): `mkdir -p ../20161019-candy/ && rsync -rav ./ ../20161019-candy/ --exclude=".git" --exclude="node_modules" --exclude=".sass-cache" --delete-after`
